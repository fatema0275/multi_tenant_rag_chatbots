...
const SectionTitle = ({ children, className = '' }) => (
  <h2 className={`font-heading font-bold text-3xl sm:text-4xl text-txt-primary-dark leading-tight ${className}`}>
    {children}
  </h2>
);

const SectionSubtitle = ({ children }) => (
  <p className="mt-4 text-[16px] text-txt-secondary-dark max-w-2xl leading-relaxed">
    {children}
  </p>
);
...
// ─── Landing Page ─────────────────────────────────────────────────────────────
const Landing = () => (
  <div className="min-h-screen bg-page-dark text-txt-primary-dark overflow-x-hidden">
    <Navbar />
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-20">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <motion.h1
              ...
              className="font-heading font-bold text-4xl sm:text-5xl lg:text-6xl leading-[1.1] tracking-tight text-white"
            >
              Your website,{' '}
            ...
            <motion.p
              ...
              className="mt-6 text-[17px] text-txt-secondary-dark leading-relaxed max-w-xl mx-auto lg:mx-0"
            >
            ...
            >
              ...
              <button
                id="hero-cta-demo"
                className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-[18px] border border-border-dark text-txt-secondary-dark text-[15px] font-semibold hover:border-accent/50 hover:text-accent transition-all duration-200"
                onClick={() => {}}
              >
            ...
            >
              {[
                ...
                <span key={tag} className="flex items-center gap-1.5 text-[13px] text-txt-secondary-dark">
    ...
    {/* ════════════════════════════════════════════════ HOW IT WORKS */}
    <Section id="how-it-works" className="border-t border-border-dark">
    ...
    {/* ═══════════════════════════════════════════════════ FEATURES */}
    <Section id="features" className="border-t border-border-dark">
      <div className="text-center mb-14">
    ...
    {/* ══════════════════════════════════════════════ ARCHITECTURE */}
    <Section id="architecture" className="border-t border-border-dark">
      <div className="mb-10">
      ...
      <div className="rounded-[18px] bg-surface-dark border border-border-dark p-6 shadow-card-dark">
        <ArchitecturePipeline />
      </div>
    </Section>

    {/* ═══════════════════════════════════════════════════════ STATS */}
    <Section id="stats" className="border-t border-border-dark">
    ...
    {/* ══════════════════════════════════════════ TESTIMONIALS */}
    <Section id="testimonials" className="border-t border-border-dark">
      <div className="text-center mb-14">
    ...
    {/* ══════════════════════════════════════════════════════ FAQ */}
    <Section id="faq" className="border-t border-border-dark">
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-12">
          <SectionLabel>FAQ</SectionLabel>
          <SectionTitle>Common questions</SectionTitle>
        </div>
        <div className="rounded-[18px] bg-surface-dark border border-border-dark px-6 divide-y divide-border-dark">
          {FAQS.map((faq, i) => (
    ...
    {/* ════════════════════════════════════════════════ CLOSING CTA */}
    <Section id="cta" className="border-t border-border-dark">
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true }}
        transition={{ duration: 0.6 }}
        className="relative rounded-[24px] bg-surface-dark border border-border-dark p-12 sm:p-16 text-center overflow-hidden"
      >
        ...
        <div className="relative">
          ...
          <p className="text-[16px] text-txt-secondary-dark max-w-xl mx-auto mb-9">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-[18px] border border-border-dark text-txt-secondary-dark text-[15px] font-semibold hover:border-zinc-600 hover:text-txt-primary-dark transition-all duration-200"
            >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12">
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 mb-10">
          ...
          <div className="col-span-2 sm:col-span-1">
            ...
            <p className="text-[13px] text-txt-secondary-dark leading-relaxed max-w-[200px]">
          ...
          {/* Product */}
          <div>
            <div className="text-[11px] font-semibold uppercase tracking-widest text-txt-secondary-dark mb-4">Product</div>
            <div className="flex flex-col gap-2.5">
              {['Features', 'How It Works', 'Architecture', 'Pricing'].map((l) => (
                <button key={l} className="text-[13px] text-txt-secondary-dark hover:text-txt-primary-dark transition-colors text-left">
                  {l}
                </button>
              ))}
            </div>
          ...
          {/* Developers */}
          <div>
            <div className="text-[11px] font-semibold uppercase tracking-widest text-txt-secondary-dark mb-4">Developers</div>
            <div className="flex flex-col gap-2.5">
              {[
          ...
          {/* Legal */}
          <div>
            <div className="text-[11px] font-semibold uppercase tracking-widest text-txt-secondary-dark mb-4">Legal</div>
            <div className="flex flex-col gap-2.5">
              {[
        ...
        <div className="pt-6 border-t border-border-dark flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-[12px] text-txt-secondary-dark">
            © {new Date().getFullYear()} SiteMind. All rights reserved.
          </p>
          <p className="text-[12px] text-txt-secondary-dark flex items-center gap-1">
