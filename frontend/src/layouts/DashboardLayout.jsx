...
const DashboardLayout = () => {
  ...
  return (
    <div className="h-screen bg-[#09090B] text-white flex font-sans antialiased overflow-hidden">
      {/* ── Left Sidebar (Desktop: md:flex) — Full Height ── */}
      <aside className="w-60 lg:w-64 shrink-0 border-r border-[#27272A] bg-[#131318] flex-col overflow-y-auto hidden md:flex z-30">
        {/* Top of Sidebar: Logo Mark + Product Name SiteMind */}
        <div className="px-5 pt-4 pb-3 border-b border-[#27272A]/40">
          ...
          <div className="mt-3 flex items-center gap-2 px-1 py-1 text-zinc-400">
        ...
        <div className="px-5 pt-5 pb-1 flex items-center justify-between">
          ...
          <button
            ...
            title="Open website switcher"
            className="text-zinc-400 hover:text-zinc-200 p-1 rounded hover:bg-[#1C1C24] transition-colors"
          >
            <Search className="w-3.5 h-3.5" />
          </button>
        </div>

        {/* Recent Sites list (max 5) */}
        <div className="px-2 py-1 space-y-0.5">
            ...
            return (
              <button
                ...
                className={`w-full flex items-center gap-2.5 px-3 py-1.5 rounded-lg text-left text-xs transition-colors cursor-pointer ${
                  isSelected
                    ? 'bg-[#1C1C24] text-white font-medium'
          ...
          {websites.length > 5 && (
            <NavLink
              ...
              className="inline-block px-3 py-1.5 text-xs text-[#22C55E] hover:underline font-medium"
            >
        ...
        <div className="mt-auto p-3 border-t border-[#27272A] space-y-1">
          <button
            ...
            className="w-full flex items-center gap-2.5 px-3 py-2 text-xs font-medium text-zinc-400 hover:text-zinc-200 hover:bg-[#1C1C24] rounded-lg transition-colors cursor-pointer"
          >
          ...
          <button
            ...
            className="w-full flex items-center gap-2.5 px-3 py-2 text-xs font-medium text-zinc-400 hover:text-red-400 hover:bg-red-500/10 rounded-lg transition-colors cursor-pointer"
          >
      ...
      {/* ── Right Shell: Top Navbar + Workspace ── */}
      <div className="flex-1 flex flex-col min-w-0 h-full overflow-hidden">
        {/* Top Navbar */}
        <header className="h-14 shrink-0 border-b border-[#27272A] bg-[#131318] px-4 sm:px-6 flex items-center justify-between z-20">
          {/* Left side: Mobile logo or Desktop Breadcrumb */}
          <div className="flex items-center gap-2.5">
            {/* Mobile Logo Mark */}
            <div className="md:hidden flex items-center gap-2">
              <div className="w-7 h-7 rounded-[8px] bg-[#22C55E] flex items-center justify-center">
            ...
            {/* Desktop Breadcrumbs (clean, eliminates duplication with page h1) */}
            ...
            >
              {activeWebsite ? (
                <span className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-semibold text-white group-hover:text-[#22C55E] transition-colors max-w-[140px] sm:max-w-[200px] truncate">
                    {activeDisplayName}
                  </span>
                </span>
              ) : (
                <span className="text-xs text-zinc-400 font-medium">Select a website</span>
              )}
              <ChevronDown
              ...
              <div className="absolute right-0 top-full mt-2 w-64 rounded-[14px] bg-[#131318] border border-[#27272A] shadow-2xl z-50 p-1.5 overflow-hidden animate-in fade-in slide-in-from-top-1 duration-150">
                    ...
                    websites.map((w) => {
                      ...
                      return (
                        <button
                          ...
                          className={`w-full flex items-center justify-between px-2.5 py-2 rounded-[8px] text-left text-xs transition-all cursor-pointer ${
                            isSelected
                ...
                <div className="pt-1 border-t border-[#27272A]/80">
                  <button
                    ...
                    className="w-full flex items-center gap-2 px-2.5 py-1.5 rounded-[8px] text-xs font-medium text-[#22C55E] hover:bg-[#22C55E]/10 transition-colors"
                  >
